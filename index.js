...
client.on("message", async message => {
  ...
  if (message.guild) {
    ...
    if (command == "setup") {
      ...
      let role = message.guild.roles.cache.find((x) => x.name == "Tickets")
      ...
      if (!message.content.startsWith(prefix)) return;
      if (!message.member.roles.cache.find((x) => x.name == "Tickets")) {
        return message.channel.send("You need Tickets role to use this command")
      }
